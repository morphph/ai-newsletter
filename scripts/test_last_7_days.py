...
{markdown_content[:10000]}"""
    ...
    async def run_test_workflow(self):
        ...
        # Process first few sources for testing
        test_sources = sources[:5]  # Test with first 5 sources
        ...
        if all_articles:
            ...
            enrichment_tasks = [self.enrich_article(article) for article in all_articles[:10]]  # Limit to 10 for testing
